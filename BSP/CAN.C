...
extern unsigned char CANaccept[8];
...
void CAN1_RX0_IRQHandler(void)
{
  ...
  RxMessage.Data[0]=0x00;     
	...
	if((RxMessage.StdId==0x11)&&(RxMessage.Data[0]==0x2f)&&(RxMessage.Data[7]==0xbb)) 
	{
		for(i=0;i<8;i++)
		{
		  CANaccept[i] = RxMessage.Data[i];			
		}
		CAN_FLAG = 1;
	}
